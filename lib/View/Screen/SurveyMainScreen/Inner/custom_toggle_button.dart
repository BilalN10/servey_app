...
class CustomToggleButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SurveController>(
      builder: (controller) {
        return Container(
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  controller.lenguageTab=0;
                  controller.update();
                },
                child: Container(
                  decoration: BoxDecoration(
                   borderRadius: BorderRadius.circular(8.r),
                    color: controller.lenguageTab==0?AppColors.yellowNormalHover:Colors.transparent,
                  ),
                  ...
                  child: Row(
                    children: [
                      ...
                      CustomText(text:"DE",fontWeight: FontWeight.w400,fontSize: 16,left: 8.w,right: 5.w,),
                    ],
                  ),
                ),
              ),
              ...
              GestureDetector(
                onTap: (){
                  controller.lenguageTab=1;
                  controller.update();
                },
                child: Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(8.r),
                    color: controller.lenguageTab==1?AppColors.yellowNormalHover:Colors.transparent,
                  ),
                  child: Row(
                    children: [
                      CustomNetworkImage(
                      ...
                      CustomText(text:"EN",fontWeight: FontWeight.w400,fontSize: 16,left: 8.w,right: 5,),
                    ],
                  ),
                ),
              ),
