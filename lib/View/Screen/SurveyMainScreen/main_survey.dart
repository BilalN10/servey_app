        ...
        body: Obx(() {
          switch (surveyController.rxRequestStatus.value) {
            ...
            case Status.completed:
              return surveyController.queEng.isEmpty
                  ? const Center(
                      child: CustomText(text: AppStaticStrings.noQuesFound),
                    )
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: PageView.builder(
                                ...
                                itemCount:
                                    surveyController.lenguageTab.value == 0
                                        ? surveyController.queNative.length
                                        : surveyController.queEng.length,
                                controller:
                                    surveyController.pageController.value,
                                itemBuilder:
                                    (BuildContext context, int itemIndex) {
                                  return CustomText(
                                    text: surveyController.lenguageTab.value ==
                                            0
                                        ? surveyController.queNative[itemIndex]
                                        : surveyController.queEng[itemIndex],
                                    fontSize: 16,
                                    fontWeight: FontWeight.w500,
                                    maxLines: 10,
                                    top: 24.h,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  CustomText(
                                      text:
                                          "${surveyController.qustionIndex.value}"),
                                  CustomText(
                                      text:
                                          "${surveyController.questionList.length}")
                                ],
                              ),
                            ),
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                  margin:
                                      EdgeInsets.symmetric(horizontal: 97.w),
